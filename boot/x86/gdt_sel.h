...
// Maintain a convention that data segment selector last 4 bits is >= 8
// Maintain a convention that code segment selector last 4 bits is < 8
#define GDT_SEL_PM_DATA16       0x08
#define GDT_SEL_PM_CODE16       0x10
#define GDT_SEL_PM_STAC16       0x18

#define GDT_SEL_PM_CODE32       0x20
#define GDT_SEL_PM_DATA32       0x28
