...
template<typename T>
static inline uint8_t bit_lsb_set(T n, false_type)
{
    return bit_lsb_set_32(int32_t(n));
}

template<typename T>
static inline uint8_t bit_lsb_set(T n, true_type)
{
    return bit_lsb_set_64(int64_t(n));
}

template<typename T>
static inline uint8_t bit_lsb_set(T n)
{
...
template<typename T>
static inline uint8_t bit_msb_set(T n, false_type)
{
    return bit_msb_set_32(int32_t(n));
}

template<typename T>
static inline uint8_t bit_msb_set(T n, true_type)
{
    return bit_msb_set_64(int64_t(n));
}

template<typename T>
static inline uint8_t bit_msb_set(T n)
{
