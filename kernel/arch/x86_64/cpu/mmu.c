...
static physaddr_t init_take_page(physmem_range_t *ranges, size_t *usable_ranges)
{
    if (*usable_ranges == 0)
        return ~0L;
...
//{
//    //static linaddr_t cur_alias_addr;
//
//    linaddr_t alias_addr = 0x800000000000 - PAGE_SIZE;
//
