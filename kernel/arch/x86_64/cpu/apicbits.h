...
// from /home/doug/code/dgos/src/kernel/arch/x86_64/cpu/apic.bits
...
#define MP_CPU_FLAGS_ENABLED_GET(n) \
    (((n) & MP_CPU_FLAGS_ENABLED) >> MP_CPU_FLAGS_ENABLED_BIT)
...
#define MP_INTR_FLAGS_POLARITY_GET(n) \
    (((n) & MP_INTR_FLAGS_POLARITY) >> MP_INTR_FLAGS_POLARITY_BIT)
...
#define IOAPIC_VER_VERSION_GET(n) \
    (((n) & IOAPIC_VER_VERSION) >> IOAPIC_VER_VERSION_BIT)
...
#define IOAPIC_REDLO_VECTOR_GET(n) \
    (((n) & IOAPIC_REDLO_VECTOR) >> IOAPIC_REDLO_VECTOR_BIT)
#define IOAPIC_REDLO_DELIVERY_GET(n) \
    (((n) & IOAPIC_REDLO_DELIVERY) >> IOAPIC_REDLO_DELIVERY_BIT)
#define IOAPIC_REDLO_DESTMODE_GET(n) \
    (((n) & IOAPIC_REDLO_DESTMODE) >> IOAPIC_REDLO_DESTMODE_BIT)
#define IOAPIC_REDLO_STATUS_GET(n) \
    (((n) & IOAPIC_REDLO_STATUS) >> IOAPIC_REDLO_STATUS_BIT)
#define IOAPIC_REDLO_POLARITY_GET(n) \
    (((n) & IOAPIC_REDLO_POLARITY) >> IOAPIC_REDLO_POLARITY_BIT)
#define IOAPIC_REDLO_REMOTEIRR_GET(n) \
    (((n) & IOAPIC_REDLO_REMOTEIRR) >> IOAPIC_REDLO_REMOTEIRR_BIT)
#define IOAPIC_REDLO_TRIGGER_GET(n) \
    (((n) & IOAPIC_REDLO_TRIGGER) >> IOAPIC_REDLO_TRIGGER_BIT)
...
#define APIC_CMD_VECTOR_GET(n) \
    (((n) & APIC_CMD_VECTOR) >> APIC_CMD_VECTOR_BIT)
#define APIC_CMD_SIPI_PAGE_GET(n) \
    (((n) & APIC_CMD_SIPI_PAGE) >> APIC_CMD_SIPI_PAGE_BIT)
#define APIC_CMD_DELIVERY_GET(n) \
    (((n) & APIC_CMD_DELIVERY) >> APIC_CMD_DELIVERY_BIT)
#define APIC_CMD_DEST_MODE_GET(n) \
    (((n) & APIC_CMD_DEST_MODE) >> APIC_CMD_DEST_MODE_BIT)
#define APIC_CMD_PENDING_GET(n) \
    (((n) & APIC_CMD_PENDING) >> APIC_CMD_PENDING_BIT)
#define APIC_CMD_LEVEL_GET(n) \
    (((n) & APIC_CMD_LEVEL) >> APIC_CMD_LEVEL_BIT)
#define APIC_CMD_ILD_GET(n)          (((n) & APIC_CMD_ILD) >> APIC_CMD_ILD_BIT)
...
#define APIC_LVT_VECTOR_GET(n) \
    (((n) & APIC_LVT_VECTOR) >> APIC_LVT_VECTOR_BIT)
#define APIC_LVT_DELIVERY_GET(n) \
    (((n) & APIC_LVT_DELIVERY) >> APIC_LVT_DELIVERY_BIT)
#define APIC_LVT_DELIVERY_STATUS_GET(n) \
    (((n) & APIC_LVT_DELIVERY_STATUS) >> APIC_LVT_DELIVERY_STATUS_BIT)
#define APIC_LVT_LINTn_POLARITY_GET(n) \
    (((n) & APIC_LVT_LINTn_POLARITY) >> APIC_LVT_LINTn_POLARITY_BIT)
#define APIC_LVT_LINTn_REMOTEIRR_GET(n) \
    (((n) & APIC_LVT_LINTn_REMOTEIRR) >> APIC_LVT_LINTn_REMOTEIRR_BIT)
#define APIC_LVT_LINTn_LEVEL_GET(n) \
    (((n) & APIC_LVT_LINTn_LEVEL) >> APIC_LVT_LINTn_LEVEL_BIT)
#define APIC_LVT_MASK_GET(n) \
    (((n) & APIC_LVT_MASK) >> APIC_LVT_MASK_BIT)
...
#define APIC_ESR_ILL_REG_GET(n) \
    (((n) & APIC_ESR_ILL_REG) >> APIC_ESR_ILL_REG_BIT)
#define APIC_ESR_RX_ILL_VEC_GET(n) \
    (((n) & APIC_ESR_RX_ILL_VEC) >> APIC_ESR_RX_ILL_VEC_BIT)
#define APIC_ESR_TX_ILL_VEC_GET(n) \
    (((n) & APIC_ESR_TX_ILL_VEC) >> APIC_ESR_TX_ILL_VEC_BIT)
#define APIC_ESR_REDIR_IPI_GET(n) \
    (((n) & APIC_ESR_REDIR_IPI) >> APIC_ESR_REDIR_IPI_BIT)
#define APIC_ESR_RX_ACCEPT_ERR_GET(n) \
    (((n) & APIC_ESR_RX_ACCEPT_ERR) >> APIC_ESR_RX_ACCEPT_ERR_BIT)
#define APIC_ESR_TX_ACCEPT_ERR_GET(n) \
    (((n) & APIC_ESR_TX_ACCEPT_ERR) >> APIC_ESR_TX_ACCEPT_ERR_BIT)
#define APIC_ESR_RX_CHECKSUM_ERR_GET(n) \
    (((n) & APIC_ESR_RX_CHECKSUM_ERR) >> APIC_ESR_RX_CHECKSUM_ERR_BIT)
...
#define ACPI_FADT_FFF_WBINVD_FLUSH_GET(n) \
    (((n) & ACPI_FADT_FFF_WBINVD_FLUSH) >> ACPI_FADT_FFF_WBINVD_FLUSH_BIT)
#define ACPI_FADT_FFF_PROC_C1_GET(n) \
    (((n) & ACPI_FADT_FFF_PROC_C1) >> ACPI_FADT_FFF_PROC_C1_BIT)
#define ACPI_FADT_FFF_P_LVL2_MP_GET(n) \
    (((n) & ACPI_FADT_FFF_P_LVL2_MP) >> ACPI_FADT_FFF_P_LVL2_MP_BIT)
#define ACPI_FADT_FFF_PWR_BUTTON_GET(n) \
    (((n) & ACPI_FADT_FFF_PWR_BUTTON) >> ACPI_FADT_FFF_PWR_BUTTON_BIT)
#define ACPI_FADT_FFF_SLP_BUTTON_GET(n) \
    (((n) & ACPI_FADT_FFF_SLP_BUTTON) >> ACPI_FADT_FFF_SLP_BUTTON_BIT)
#define ACPI_FADT_FFF_FIX_RTC_GET(n) \
    (((n) & ACPI_FADT_FFF_FIX_RTC) >> ACPI_FADT_FFF_FIX_RTC_BIT)
#define ACPI_FADT_FFF_RTC_S4_GET(n) \
    (((n) & ACPI_FADT_FFF_RTC_S4) >> ACPI_FADT_FFF_RTC_S4_BIT)
#define ACPI_FADT_FFF_TMR_VAL_EXT_GET(n) \
    (((n) & ACPI_FADT_FFF_TMR_VAL_EXT) >> ACPI_FADT_FFF_TMR_VAL_EXT_BIT)
#define ACPI_FADT_FFF_DCK_CAP_GET(n) \
    (((n) & ACPI_FADT_FFF_DCK_CAP) >> ACPI_FADT_FFF_DCK_CAP_BIT)
#define ACPI_FADT_FFF_RESET_REG_SUP_GET(n) \
    (((n) & ACPI_FADT_FFF_RESET_REG_SUP) >> ACPI_FADT_FFF_RESET_REG_SUP_BIT)
#define ACPI_FADT_FFF_SEALED_CASE_GET(n) \
    (((n) & ACPI_FADT_FFF_SEALED_CASE) >> ACPI_FADT_FFF_SEALED_CASE_BIT)
#define ACPI_FADT_FFF_HEADLESS_GET(n) \
    (((n) & ACPI_FADT_FFF_HEADLESS) >> ACPI_FADT_FFF_HEADLESS_BIT)
#define ACPI_FADT_FFF_CPU_SW_SLP_GET(n) \
    (((n) & ACPI_FADT_FFF_CPU_SW_SLP) >> ACPI_FADT_FFF_CPU_SW_SLP_BIT)
#define ACPI_FADT_FFF_PCI_EXP_WAK_GET(n) \
    (((n) & ACPI_FADT_FFF_PCI_EXP_WAK) >> ACPI_FADT_FFF_PCI_EXP_WAK_BIT)
#define ACPI_FADT_FFF_PLAT_CLOCK_GET(n) \
    (((n) & ACPI_FADT_FFF_PLAT_CLOCK) >> ACPI_FADT_FFF_PLAT_CLOCK_BIT)
#define ACPI_FADT_FFF_S4_RTC_STS_GET(n) \
    (((n) & ACPI_FADT_FFF_S4_RTC_STS) >> ACPI_FADT_FFF_S4_RTC_STS_BIT)
#define ACPI_FADT_FFF_REMOTE_ON_CAP_GET(n) \
    (((n) & ACPI_FADT_FFF_REMOTE_ON_CAP) >> ACPI_FADT_FFF_REMOTE_ON_CAP_BIT)
#define ACPI_FADT_FFF_FORCE_CLUSTER_GET(n) \
...
#define ACPI_HPET_BLKID_PCI_VEN_n(n) \
    ((n) << ACPI_HPET_BLKID_PCI_VEN_BIT)
#define ACPI_HPET_BLKID_LEGACY_CAP_n(n) \
    ((n) << ACPI_HPET_BLKID_LEGACY_CAP_BIT)
#define ACPI_HPET_BLKID_COUNTER_SZ_n(n) \
    ((n) << ACPI_HPET_BLKID_COUNTER_SZ_BIT)
#define ACPI_HPET_BLKID_NUM_TIM_CMP_n(n) \
    ((n) << ACPI_HPET_BLKID_NUM_TIM_CMP_BIT)
#define ACPI_HPET_BLKID_REV_ID_n(n) \
    ((n) << ACPI_HPET_BLKID_REV_ID_BIT)

#define ACPI_HPET_BLKID_COUNTER_CLK_PERIOD_GET(n) \
    (((n) & ACPI_HPET_BLKID_COUNTER_CLK_PERIOD) \
    >> ACPI_HPET_BLKID_COUNTER_CLK_PERIOD_BIT)
#define ACPI_HPET_BLKID_PCI_VEN_GET(n) \
    (((n) & ACPI_HPET_BLKID_PCI_VEN) >> ACPI_HPET_BLKID_PCI_VEN_BIT)
#define ACPI_HPET_BLKID_LEGACY_CAP_GET(n) \
    (((n) & ACPI_HPET_BLKID_LEGACY_CAP) >> ACPI_HPET_BLKID_LEGACY_CAP_BIT)
#define ACPI_HPET_BLKID_COUNTER_SZ_GET(n) \
    (((n) & ACPI_HPET_BLKID_COUNTER_SZ) >> ACPI_HPET_BLKID_COUNTER_SZ_BIT)
#define ACPI_HPET_BLKID_NUM_TIM_CMP_GET(n) \
    (((n) & ACPI_HPET_BLKID_NUM_TIM_CMP) >> ACPI_HPET_BLKID_NUM_TIM_CMP_BIT)
