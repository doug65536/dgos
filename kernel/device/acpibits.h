...
#define ACPI_PM1_STS_TMR_STS_GET(n) \
    (((n) & ACPI_PM1_STS_TMR_STS) >> ACPI_PM1_STS_TMR_STS_BIT)
#define ACPI_PM1_STS_BM_STS_GET(n) \
    (((n) & ACPI_PM1_STS_BM_STS) >> ACPI_PM1_STS_BM_STS_BIT)
#define ACPI_PM1_STS_GBL_STS_GET(n) \
    (((n) & ACPI_PM1_STS_GBL_STS) >> ACPI_PM1_STS_GBL_STS_BIT)
#define ACPI_PM1_STS_PWRBTN_STS_GET(n) \
    (((n) & ACPI_PM1_STS_PWRBTN_STS) >> ACPI_PM1_STS_PWRBTN_STS_BIT)
#define ACPI_PM1_STS_SLPBTN_STS_GET(n) \
    (((n) & ACPI_PM1_STS_SLPBTN_STS) >> ACPI_PM1_STS_SLPBTN_STS_BIT)
#define ACPI_PM1_STS_RTC_STS_GET(n) \
    (((n) & ACPI_PM1_STS_RTC_STS) >> ACPI_PM1_STS_RTC_STS_BIT)
#define ACPI_PM1_STS_PCIEXP_WAKE_STS_GET(n) \
    (((n) & ACPI_PM1_STS_PCIEXP_WAKE_STS) >> ACPI_PM1_STS_PCIEXP_WAKE_STS_BIT)
#define ACPI_PM1_STS_WAK_STS_GET(n) \
    (((n) & ACPI_PM1_STS_WAK_STS) >> ACPI_PM1_STS_WAK_STS_BIT)
...
#define ACPI_PM1_EVT_TMR_EN_GET(n) \
    (((n) & ACPI_PM1_EVT_TMR_EN) >> ACPI_PM1_EVT_TMR_EN_BIT)
#define ACPI_PM1_EVT_GBL_EN_GET(n) \
    (((n) & ACPI_PM1_EVT_GBL_EN) >> ACPI_PM1_EVT_GBL_EN_BIT)
#define ACPI_PM1_EVT_PWRBTN_EN_GET(n) \
    (((n) & ACPI_PM1_EVT_PWRBTN_EN) >> ACPI_PM1_EVT_PWRBTN_EN_BIT)
#define ACPI_PM1_EVT_SLPBTN_EN_GET(n) \
    (((n) & ACPI_PM1_EVT_SLPBTN_EN) >> ACPI_PM1_EVT_SLPBTN_EN_BIT)
#define ACPI_PM1_EVT_RTC_EN_GET(n) \
    (((n) & ACPI_PM1_EVT_RTC_EN) >> ACPI_PM1_EVT_RTC_EN_BIT)
#define ACPI_PM1_EVT_PCIEXP_WAKE_DIS_GET(n) \
    (((n) & ACPI_PM1_EVT_PCIEXP_WAKE_DIS) >> ACPI_PM1_EVT_PCIEXP_WAKE_DIS_BIT)
...
#define ACPI_PM1_CTL_SCI_EN_GET(n) \
    (((n) & ACPI_PM1_CTL_SCI_EN) >> ACPI_PM1_CTL_SCI_EN_BIT)
#define ACPI_PM1_CTL_BM_RLD_GET(n) \
    (((n) & ACPI_PM1_CTL_BM_RLD) >> ACPI_PM1_CTL_BM_RLD_BIT)
#define ACPI_PM1_CTL_GBL_RLS_GET(n) \
    (((n) & ACPI_PM1_CTL_GBL_RLS) >> ACPI_PM1_CTL_GBL_RLS_BIT)
#define ACPI_PM1_CTL_SLP_TYP_GET(n) \
    (((n) & ACPI_PM1_CTL_SLP_TYP) >> ACPI_PM1_CTL_SLP_TYP_BIT)
#define ACPI_PM1_CTL_SLP_EN_GET(n) \
    (((n) & ACPI_PM1_CTL_SLP_EN) >> ACPI_PM1_CTL_SLP_EN_BIT)
...
#define ACPI_PM_TMR_CNT_24_GET(n) \
    (((n) & ACPI_PM_TMR_CNT_24) >> ACPI_PM_TMR_CNT_24_BIT)
#define ACPI_PM_TMR_CNT_32_GET(n) \
    (((n) & ACPI_PM_TMR_CNT_32) >> ACPI_PM_TMR_CNT_32_BIT)
...
#define ACPI_PM2_CTL_ARB_DIS_GET(n) \
    (((n) & ACPI_PM2_CTL_ARB_DIS) >> ACPI_PM2_CTL_ARB_DIS_BIT)
...
#define ACPI_P_CNT_CLK_VAL1_GET(n) \
    (((n) & ACPI_P_CNT_CLK_VAL1) >> ACPI_P_CNT_CLK_VAL1_BIT)
#define ACPI_P_CNT_THT_EN_GET(n) \
    (((n) & ACPI_P_CNT_THT_EN) >> ACPI_P_CNT_THT_EN_BIT)
#define ACPI_P_CNT_CLK_VAL2_GET(n) \
    (((n) & ACPI_P_CNT_CLK_VAL2) >> ACPI_P_CNT_CLK_VAL2_BIT)
...
#define ACPI_P_LVL2_P_LVL2_GET(n) \
    (((n) & ACPI_P_LVL2_P_LVL2) >> ACPI_P_LVL2_P_LVL2_BIT)
...
#define ACPI_P_LVL3_P_LVL3_GET(n) \
    (((n) & ACPI_P_LVL3_P_LVL3) >> ACPI_P_LVL3_P_LVL3_BIT)
...
#define ACPI_SLEEP_CTL_SLP_TYP_GET(n) \
    (((n) & ACPI_SLEEP_CTL_SLP_TYP) >> ACPI_SLEEP_CTL_SLP_TYP_BIT)
#define ACPI_SLEEP_CTL_SLP_EN_GET(n) \
    (((n) & ACPI_SLEEP_CTL_SLP_EN) >> ACPI_SLEEP_CTL_SLP_EN_BIT)
...
#define ACPI_SLEEP_STS_WAK_STS_GET(n) \
    (((n) & ACPI_SLEEP_STS_WAK_STS) >> ACPI_SLEEP_STS_WAK_STS_BIT)
